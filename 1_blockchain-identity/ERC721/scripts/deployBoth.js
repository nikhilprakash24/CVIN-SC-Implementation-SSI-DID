...
async function main() {
    ...
    const CVIN_NFT_DID_ERC721 = await hre.ethers.getContractFactory("CVIN_NFT_DID_ERC721");
    const cvin_nft_did_erc721 = await CVIN_NFT_DID_ERC721.deploy("CVIN", "CVN", deployer.address, 500);

    await cvin_nft_did_erc721.deployed();
    console.log("CVIN_NFT_DID_ERC721 deployed to:", cvin_nft_did_erc721.address);
